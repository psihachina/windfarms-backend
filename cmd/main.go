...
import (
	...
	"github.com/psihachina/windfarms-backend"
	"github.com/psihachina/windfarms-backend/pkg/handler"
...
func main() {
	...
	db, err := repository.NewPostgresDB(cfg.String())
